...
filelist_content=r'"path":"([^"]*)"'  #正则，获取参数值
'''
...
class bdpanSpider:
    def __init__(self):
        ...
        self.file_list_p=re.compile(filelist_content, re.M)
        self.app_id=""
        self.uk=""
        self.bdstoken=""
        self.shareid=""
    ...
    def getbody(self,url):
        ...
        try:
            ...
            L=self.file_list_p.findall(content)
            [self.file_list.append(i.replace('\\/', '/')) for i in L if i not in self.file_list]
    ...
    def addziyuan(self):
        ...
        payload = {
            "filelist": list(set(self.file_list)),
            "path": "/1080p"
                }
